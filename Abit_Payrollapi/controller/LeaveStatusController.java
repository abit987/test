...
import com.payrollapi.api.repositories.LeaveStatusRepository;
import com.payrollapi.api.service.LeaveStatusService;
...
public class LeaveStatusController 
{
    ...
    public ResponseEntity<List<com.payrollapi.api.entity.leaveStatusEntity>> getApprovedLeavesForAllEmployees() 
    {
        List<com.payrollapi.api.entity.leaveStatusEntity> approvedLeavesList = leaveStatusService.getApprovedLeavesForAllEmployees();
        return ResponseEntity.ok(approvedLeavesList);
    }

    @RequestMapping(value = "/rejectedLeaves", method = RequestMethod.GET)
    public ResponseEntity<List<com.payrollapi.api.entity.leaveStatusEntity>> getRejectedLeavesForAllEmployees() 
    {
        List<com.payrollapi.api.entity.leaveStatusEntity> rejectedLeavesList = leaveStatusService.getRejectedLeavesForAllEmployees();
